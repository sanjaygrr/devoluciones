...
SECRET_KEY = 'django-insecure-ozhh7$%c@lo%dpn%3jc^rb12g4ihy=$(3g0^m#+2wta2ni93ew'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Permite todos los hosts en Heroku
...
ROOT_URLCONF = 'devoluciones_project.urls'
...
WSGI_APPLICATION = 'devoluciones_project.wsgi.application'
...
BSALE_BASE_URL = os.getenv('BSALE_BASE_URL', 'https://api.bsale.cl/v1')
